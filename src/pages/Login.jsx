      ...
      <div className='login'>
        ...
        <div className="login-container">
          ...
          <form >
            ...
            <button className='btn btn-full' type='submit' onClick={signIn}>Sign In</button>
          </form>
          <p>
              By signing-in you agree to the AMAZON FAKE CLONE Conditions of Use & Sale. Please
              see our Privacy Notice, our Cookies Notice and our Interest-Based Ads Notice.
          </p>
          <button className='btn btn-full btn-register' onClick={register}>Create your Amazon account</button>
        </div>
      </div>
  )
}
